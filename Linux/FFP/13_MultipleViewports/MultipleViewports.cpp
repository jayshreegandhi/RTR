			...
			switch(event.type)
			{
				...
				case KeyPress:
					...
					switch(keysym)
					{
						...
						case '0':
							glViewport(gX, gY, (GLsizei)winWidth, (GLsizei)winHeight);
							break;

						case '1':
							glViewport(gX, gY, (GLsizei)winWidth/2,(GLsizei)winHeight/2);
							break;

						case '2':
							glViewport(winWidth/2, gY, (GLsizei)winWidth/2 ,(GLsizei)winHeight/2);
							break;

						case '3':
							glViewport(gX, winHeight/2, (GLsizei)winWidth / 2,(GLsizei)winHeight / 2);
							break;
						...
						case '5':
							glViewport(gX, gY,(GLsizei)winWidth / 2,(GLsizei)winHeight);
							break;
						...
						case '7':
							glViewport(gX, winHeight / 2,(GLsizei)winWidth, (GLsizei)winHeight / 2);
							break;

						case '8':
							glViewport(gX, gY,(GLsizei)winWidth, (GLsizei)winHeight / 2);
							break;
