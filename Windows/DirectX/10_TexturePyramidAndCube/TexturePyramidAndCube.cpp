...
HRESULT initialize(void)
{
	...
	//color
	D3D11_BUFFER_DESC bufferDesc_VertexBuffer_Texture_Pyramid;
	ZeroMemory(&bufferDesc_VertexBuffer_Texture_Pyramid, sizeof(D3D11_BUFFER_DESC));
	bufferDesc_VertexBuffer_Texture_Pyramid.Usage = D3D11_USAGE_DYNAMIC;
	bufferDesc_VertexBuffer_Texture_Pyramid.ByteWidth = sizeof(float) * ARRAYSIZE(pyramidTexcoord);
	bufferDesc_VertexBuffer_Texture_Pyramid.BindFlags = D3D11_BIND_VERTEX_BUFFER;
	...
	{
		fopen_s(&gpFile, gszLogFileName, "a+");
		fprintf_s(gpFile, "ID3D11Device::CreateBuffer() succeeded for vertex buffer texture pyramid.\n");
		fclose(gpFile);
	}
	...
	//D3D11_MAPPED_SUBRESOURCE mappedSubresource;
	ZeroMemory(&mappedSubresource, sizeof(D3D11_MAPPED_SUBRESOURCE));
	gpID3D11DeviceContext->Map(gpID3D11Buffer_VertexBuffer_Texture_Pyramid, NULL, D3D11_MAP_WRITE_DISCARD, NULL, &mappedSubresource);
	...
	//color
	D3D11_BUFFER_DESC bufferDesc_VertexBuffer_Texture_Cube;
	ZeroMemory(&bufferDesc_VertexBuffer_Texture_Cube, sizeof(D3D11_BUFFER_DESC));
	bufferDesc_VertexBuffer_Texture_Cube.Usage = D3D11_USAGE_DYNAMIC;
	bufferDesc_VertexBuffer_Texture_Cube.ByteWidth = sizeof(float) * ARRAYSIZE(cubeTexcoord);
	bufferDesc_VertexBuffer_Texture_Cube.BindFlags = D3D11_BIND_VERTEX_BUFFER;
	...
	{
		fopen_s(&gpFile, gszLogFileName, "a+");
		fprintf_s(gpFile, "ID3D11Device::CreateBuffer() succeeded for vertex buffer texture cube.\n");
		fclose(gpFile);
	}
	...
	//D3D11_MAPPED_SUBRESOURCE mappedSubresource;
	ZeroMemory(&mappedSubresource, sizeof(D3D11_MAPPED_SUBRESOURCE));
	gpID3D11DeviceContext->Map(gpID3D11Buffer_VertexBuffer_Texture_Cube, NULL, D3D11_MAP_WRITE_DISCARD, NULL, &mappedSubresource);
...
void display(void)
{
	...
	offset = 0;
	gpID3D11DeviceContext->IASetVertexBuffers(1, 1, &gpID3D11Buffer_VertexBuffer_Texture_Pyramid, &stride, &offset);
