...
int initialize(void)
{
	...
	const GLchar *vertexShaderSourceCode =
		...
		"void main(void)" \
		"{" \
		"gl_Position = u_mvp_matrix * (vPosition + u_offset * u_scale);" \
	...
	offsetUniform = glGetUniformLocation(gShaderProgramObject,
		"u_offset");

	scaleUniform = glGetUniformLocation(gShaderProgramObject,
		"u_scale");
...
void display(void)
{
	...
	glUniform1f(scaleUniform, scale_x);
