...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    private int[] texture_image = new int[1];
    ...
    private void initialize() {
        ...
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, 12 * 4, null,
    ...
    private void display() {
        ...
        GLES32.glBindTexture(GLES32.GL_TEXTURE_2D, texture_image[0]);
        ...
        byteBufferPositionRectangle = ByteBuffer.allocateDirect(rectangleVertices.length * 4);
        byteBufferPositionRectangle.order(ByteOrder.nativeOrder());

        positionBufferRectangle = byteBufferPositionRectangle.asFloatBuffer();
        positionBufferRectangle.put(rectangleVertices);
        positionBufferRectangle.position(0);
    ...
    private void uninitialize() {
        if (texture_image[0] != 0) {
            GLES32.glDeleteTextures(1, texture_image, 0);
            texture_image[0] = 0;
        }
